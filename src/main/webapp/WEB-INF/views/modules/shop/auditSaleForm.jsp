...
<head>
	...
	<script type="text/javascript">
							...
							if(data=="success"){	
								...
								top.$.jBox.confirm('本号码已发布店铺，是否继续?','系统提示',function(v,h,f){
									if(v==true){
										...
										window.location.href = '${ctx}/shop/member/list?sourceType=1';
									}
		...
		function rejectClick() {
			$('#tempFollowNote').val($('#followNote').val());
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/shop/member/list?sourceType=1">需求列表</a></li>
		<li class="active"><a href="javascript:void(0);">店铺审核</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="shop" action="${ctx}/shop/shop/auditShop" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<fieldset>
			<table class="table-form">
				...
				<tr>
					...
					<td colspan="4"><form:input path="shopAddress" htmlEscape="false" maxlength="500" class="input-xlarge required"/><span class="help-inline"><font color="red">*</font></span></td>
				</tr>
				<!-- 经营状况 -->
				<tr>
				...
				<tr>
					...
					<td class="tit">位置</td>
					<td colspan="4"><form:input path="position" htmlEscape="false" maxlength="500" class="input-xlarge "/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><form:input path="useArea" htmlEscape="false" maxlength="20" class="input-xlarge required"/><span class="help-inline">㎡<font color="red">*</font></span></td>
					<td class="tit">面宽</td>
					<td colspan="4"><form:input path="faceWidth" htmlEscape="false" maxlength="10" class="input-xlarge "/><span class="help-inline">米</span></td>
				</tr>
				<tr>
					<td class="tit">进深</td>
					<td><form:input path="depth" htmlEscape="false" maxlength="20" class="input-xlarge "/><span class="help-inline">米</span></td>
					<td class="tit">层高</td>
					<td><form:input path="floorHeight" htmlEscape="false" maxlength="20" class="input-xlarge "/><span class="help-inline">米</span></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="4"><form:textarea path="followNote" htmlEscape="false" maxlength="100" class="input-xlarge " style="height:120px;width:600px;"/>
		...
		<div class="form-actions">
			<input id="btnSubmit" class="btn btn-primary" type="button"  onclick="passClick();" value="通过"/>&nbsp;
			<input id="btnSubmit" class="btn btn-primary" type="button" onclick="rejectClick();"  value="拒绝"/>&nbsp;
			<input id="btnCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>
		</div>
	</form:form>
	
	<form:form id="rejectForm" modelAttribute="shop" action="${ctx}/shop/shop/rejectShop" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<input type="hidden" name="showFlag" value="2"/>		
		<input type="hidden" name="memberId" value="${memberId}"/>
		<input type="hidden" id="tempFollowNote" name="followNote" value=""/>
	</form:form>
</body>
</html>