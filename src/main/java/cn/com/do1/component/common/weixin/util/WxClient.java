...
public class WxClient {
    ...
    public static JSONObject getOpenid(String code) throws Exception, BaseException {
        ...
        System.out.println("############getOpenid&&&url:"+url);
//        JSONObject json = new HttpHelperV2().getJSONFromHttp(url, param, 0);
        JSONObject json = HttpUtil.httpRequest(url, "GET", null);
        System.out.println("############getOpenid&&&json:"+json);
        checkError(json);
    ...
    public static void main(String[] args) throws Exception {
    	Map<String, Object> param = new HashMap<String, Object>();
    	String url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=wx8686ee7e22e84b1b&secret=22af88322794752a811c7b26840cc0e0&code=001v9iUe1zC0Wm0r3cSe1d3eUe1v9iUq&grant_type=authorization_code";
    	//JSONObject json = new HttpHelperV2().getJSONFromHttp(url, param, 0);
    	JSONObject json = HttpUtil.httpRequest(url, "GET", null);
